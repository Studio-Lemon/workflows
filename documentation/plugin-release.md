...
- **Type:** `boolean`
- **Description:** When `true`, deploys the plugin to the satispress server via rsync after the release. Requires `remote_host`, `remote_user`, and the `deploy_key` secret.
- **Default:** `false`
